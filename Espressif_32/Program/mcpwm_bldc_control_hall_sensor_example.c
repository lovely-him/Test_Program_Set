...
/*
总结：主要测试了 pwm的占空比修改和cap的脉冲捕获功能。注释写着是给 无刷直流电机控制 的例子。
*/
...
#define INITIAL_DUTY 10.0   //initial duty cycle is 10.0% 初始占空比为10.0%
#define MCPWM_GPIO_INIT 0   //select which function to use to initialize gpio signals 选择使用哪个函数来初始化gpio信号

// 使这个1使产生的霍尔传感器测试信号在GPIO13, 12, 14
